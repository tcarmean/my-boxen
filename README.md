...
1. https://github.com/boxen/our-boxen (README is below)
...
3. This link also has good information: http://garylarizza.com/blog/2013/02/15/puppet-plus-github-equals-laptop-love/

__Staging a new machine__

1. Install full xcode from the App Store (required to build macvim package)
2. Install xcode command line utils and ACCEPT THE LICENSE!!!
